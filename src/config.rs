...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            asr: AsrConfig {
                encoder: PathBuf::from("./models/encoder.onnx"),
                decoder: PathBuf::from("./models/decoder.onnx"),
                joiner: PathBuf::from("./models/joiner.onnx"),
                tokens: PathBuf::from("./models/tokens.txt"),
                provider: "cpu".into(),
                chunk_size: 3200,
                sample_rate: 16000,
            },
